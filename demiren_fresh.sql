...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 26, 2025 at 02:35 PM
...
(1, 1, 'Admin', 'User', 'admin', '09000000000', 'admin@demiren.com', 'admin123', 'Hotel Address', '1990-01-01', 'Male', '2025-01-01 00:00:00', NULL, 'Active'),
...
--
ALTER TABLE `tbl_booking_history`
  MODIFY `booking_history_id` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tbl_customers_online`
  MODIFY `customers_online_id` int(11) NOT NULL AUTO_INCREMENT;
